...
: ${TURTLEBOT_INTERACTIONS_LIST:=[turtlebot_laser_bringup/admin.interactions, turtlebot_laser_bringup/documentation.interactions, turtlebot_laser_bringup/pairing.interactions, turtlebot_laser_bringup/visualisation.interactions]}
